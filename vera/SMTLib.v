...
Section Interpretation.
  ...
  Lemma value_eqb_neq s v1 v2 : @value_eqb s v1 v2 = false <-> v1 <> v2.
  Proof.
    split; intros H.
    - intros contra.
      apply value_eqb_eq in contra.
      congruence.
    - destruct (value_eqb v1 v2) eqn:E; try reflexivity.
      apply value_eqb_eq in E.
      contradiction.
  Qed.
