...
From ExtLib Require Structures.MonadState.
...
From vera Require BitvectorInterface.
...
Module Make(BV : BitvectorInterface.Bitvector).
  Import (hints) Structures.MonadState.
  Module TypedVerilog := MkTypedVerilog(BV).
  ...
  Global Instance MonadState_transf : MonadState state transf := MonadState_stateT state (Monad_either string).
