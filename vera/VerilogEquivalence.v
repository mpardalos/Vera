...
Program Definition equivalence_query (verilog1 verilog2 : Verilog.vmodule) : sum string (SMT.smt_with_namemap) :=
  ...
  smt1 <- VerilogToSMT.verilog_to_smt TaggedVariable.VerilogLeft 0 verilog1 ;;
  smt2 <- VerilogToSMT.verilog_to_smt TaggedVariable.VerilogRight (1 + SMT.max_var (SMT.query smt1)) verilog2 ;;
