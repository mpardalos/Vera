...
miss_state miss_state(	valid_diag_window,
  					...
  					pcsu_powerdown,
  					jmp_e,
                                          ibuf_full, reset_l, ic_miss_state, clk);
...
module miss_state (valid_diag_window, icu_miss, normal_ack, cacheable, error_ack, pcsu_powerdown, jmp_e, ibuf_full, reset_l, miss_state_output, clk);
//input   [6:0]  	cur_state ;
