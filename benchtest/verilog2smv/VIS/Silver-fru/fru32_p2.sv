...
reg 	 EXU_Cond,		// Norm = 1 & = 0 iff cmov false     (from EXU)
   ...
   // Use 32 entries to match initialization of registers 0-31 and the
   // documented 32-register file with five-bit register addresses.
