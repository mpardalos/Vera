...
//IF;
	...
	wire is_IF	= State[2:0]==3'd0;
	wire is_ID	= State[2:0]==3'd1;
	wire EXE = State[2:0]==3'd2;
	wire is_MEM = State[2:0]==3'd3;
	wire is_WB	= State[2:0]==3'd4;
...
//G(\is_WB * branch=1 * adFld1[1:0]=0 -> PC[4:0]==ALUOutput[4:0]);
	assert property (	!(is_WB && branch && adFld1[1:0]==2'd0) || PC[4:0]==ALUOutput[4:0]	);
